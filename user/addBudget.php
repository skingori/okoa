        ...
        <form class="user" method="POST" action="">
            <div class="form-group row">
                <div class="col-sm-5 mb-3 mb-sm-0">
                    <input type="text" class="form-control" name="budget_name" id="budget_name" placeholder="Budget name" required>
                </div>
                <div class="col-sm-3 mb-3 mb-sm-0">
                    <input type="number" class="form-control" name="budget_amount" id="budget_amount" placeholder="Amount" required>
                </div>
                <div class="col-sm-4">
